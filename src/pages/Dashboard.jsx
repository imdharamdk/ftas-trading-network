...
const TELEGRAM_COMMUNITY_LINK = "https://t.me/ftassignals";
  ...
  return (
    ...
    >
      ...
      <section className="section-grid" style={{ gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))" }}>
        ...
        {/* Telegram Channel */}
        <article className="panel" style={{
          background: "linear-gradient(135deg, rgba(34,158,217,0.14) 0%, rgba(34,158,217,0.05) 100%)",
          border: "1px solid rgba(34,158,217,0.28)",
          display: "flex", flexDirection: "column", gap: "16px",
        }}>
          <div className="panel-header" style={{ marginBottom: 0 }}>
            <div>
              <span className="eyebrow" style={{ color: "#229ED9" }}>Community</span>
              <h2 style={{ display: "flex", alignItems: "center", gap: "8px", marginTop: "4px" }}>
                <svg width="22" height="22" viewBox="0 0 24 24" fill="#229ED9" xmlns="http://www.w3.org/2000/svg">
                  <path d="M9.036 15.804l-.37 5.204c.53 0 .759-.228 1.034-.502l2.48-2.372 5.139 3.763c.942.52 1.607.246 1.861-.867l3.373-15.816.001-.001c.299-1.396-.505-1.942-1.423-1.6L1.43 11.13c-1.345.523-1.325 1.274-.229 1.61l5.034 1.571L17.928 6.93c.551-.365 1.052-.163.64.202"/>
                </svg>
                Telegram Channel
              </h2>
            </div>
            <span className="pill pill-accent">Instant</span>
          </div>

          <p style={{ color: "var(--c-muted)", fontSize: "0.86rem", lineHeight: 1.6, margin: 0 }}>
            Join our Telegram channel for fast FTAS signal updates, market alerts, and direct trading broadcast posts in one place.
          </p>

          <div style={{ display: "flex", flexWrap: "wrap", gap: "10px", fontSize: "0.82rem", color: "var(--c-muted)" }}>
            {["🚀 Fast Alerts", "📣 Broadcast Updates", "📍 Easy To Join"].map(t => (
              <span key={t} style={{ background: "rgba(34,158,217,0.1)", border: "1px solid rgba(34,158,217,0.15)", borderRadius: "20px", padding: "4px 10px", color: "#229ED9", fontWeight: 600 }}>{t}</span>
            ))}
          </div>
          ...
          <div style={{
            ...
            <strong style={{ color: "#e2e8f0", fontSize: "0.95rem" }}>How to join</strong>
            <p style={{ margin: 0, color: "var(--c-muted)", fontSize: "0.84rem", lineHeight: 1.6 }}>
              Tap the join button, open the FTAS Telegram channel, then select <strong style={{ color: "#e2e8f0" }}>Join</strong> inside Telegram to start receiving updates.
            </p>
            <span style={{ color: "#229ED9", fontSize: "0.8rem", fontWeight: 700 }}>Link: @ftassignals</span>
          </div>
          ...
          <a
            ...
            style={{
              display: "flex", alignItems: "center", justifyContent: "center", gap: "8px",
              background: "linear-gradient(135deg, #229ED9, #167db0)",
              color: "#fff", fontWeight: 700, fontSize: "0.92rem",
              padding: "12px 20px", borderRadius: "12px", textDecoration: "none",
            ...
            onMouseEnter={e => { e.currentTarget.style.transform = "translateY(-2px)"; e.currentTarget.style.boxShadow = "0 8px 24px rgba(34,158,217,0.38)"; }}
            onMouseLeave={e => { e.currentTarget.style.transform = "none"; e.currentTarget.style.boxShadow = "0 4px 16px rgba(34,158,217,0.3)"; }}
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="white" xmlns="http://www.w3.org/2000/svg">
              <path d="M9.036 15.804l-.37 5.204c.53 0 .759-.228 1.034-.502l2.48-2.372 5.139 3.763c.942.52 1.607.246 1.861-.867l3.373-15.816.001-.001c.299-1.396-.505-1.942-1.423-1.6L1.43 11.13c-1.345.523-1.325 1.274-.229 1.61l5.034 1.571L17.928 6.93c.551-.365 1.052-.163.64.202"/>
            </svg>
